    ...
    <body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-offset="100">
            ...
            <section id="blog" class="blog">
                <div class="container" data-aos="fade-up">
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="sidebar">
                                <label class="sidebar-title">Dokumen</label>
                                &nbsp;&nbsp;
                                <?php
                                if($rahasia == "ya"){
                                    ?>
                                <a style="font-size: 12px; color: blue;" href="javascript:void(0)" onclick="viewnonpass('<?php echo $kode; ?>','ya')">View Document</a>
                                    <?php
                                }else if($rahasia == "tidak"){
                                    ?>
                                <a style="font-size: 12px; color: blue;" href="javascript:void(0)" onclick="viewnonpass('<?php echo $kode; ?>','tidak')">View Document</a>
                                    <?php
                                }
                                ?>
                                ...
                                <div class="sidebar-item categories">
                                    <ul class="list-group">
                                        ...
                                        foreach ($dokumen->result() as $row) {
                                            if($rahasia == "ya"){
                                                ?>
                                        <li class="list-group-item"><a onclick="unduh('<?php echo $kode; ?>','<?php echo base_url(); ?>singlepenelitian/unduhfile/<?php echo $row->iddokumen; ?>')" style="color: blue;" href="javascript:void(0)"><?php echo $row->judul_dok; ?></a></li>
                                                <?php
                                            }else if($rahasia == "tidak"){
                                                ?>
                                        <li class="list-group-item">
                                            <a style="font-size: 12px; color: blue;" href="javascript:void(0)" onclick="unduhnonpass('<?php echo $row->iddokumen; ?>')"><?php echo $row->judul_dok; ?></a>
                                        </li>
                                                <?php
                                            }
                                        }
        ...
        <footer id="footer" class="footer">
            ...
            <div class="container">
                ...
                <div class="credits">
                    Created by <a href="https://pramediaenginering.com">CATUR</a>
                </div>
            </div>
            
        </footer><!-- End Footer -->

        <div class="modal fade" id="modal_img" tabindex="-1" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-horizontal">
                            <div id="wadah_gambar" style="width: 100%;"></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script type="text/javascript">
            ...
            function unduhnonpass(iddok){
                window.location.href = "<?php echo base_url(); ?>singlepenelitian/unduhfile/" + iddok;
            }
            
            function viewnonpass(iddok, rahasia){
                if(rahasia === "ya"){
                    var sandi = prompt("Masukkan sandi dokumen ?", "");
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if(response.status === "oke"){
                                ...
                                $.ajax({
                                    url: "<?php echo base_url(); ?>singlepenelitian/loadgambar/" + iddok,
                                    type: "POST",
                                    dataType: "JSON",
                                    success: function (data) {
                                        $('#wadah_gambar').html(data.hasil);
                                    }, error: function (jqXHR, textStatus, errorThrown) {
