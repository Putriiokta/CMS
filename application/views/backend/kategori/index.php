<script type="text/javascript">
    ...
    function hapus(id, nama) {
        if (confirm("Apakah anda yakin menghapus kategori berita " + nama + " ?")) {
            $.ajax({
    ...
    function ganti(id) {
        ...
        $('#form')[0].reset();
        $('#modal_form').modal('show');
        $('.modal-title').text('Ganti kategori');
        $.ajax({
...
<div class="content-wrapper">
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">MASTER KATEGORI BERITA</h4>
                    <p class="card-description">Maintenance data kategori berita</p>
